...
const loadingFallback = (
  <div className="min-h-[40vh] w-full flex items-center justify-center bg-background">
    <div
      ...
      >
        ...
        <Suspense fallback={loadingFallback}>
          <Routes>
            ...
            <Route path="/balao-intragastrico-preco" element={<BalaoIntragasticoPreco />} />
            ...
            <Route path="/mapa-metabolico" element={<MapaMetabolico />} />
