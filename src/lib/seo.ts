...
export const pageSEO: Record<string, SEOData> = {
  home: {
    title:
      "Dra. Bruna Durelli - Especialista em Obesidade | Programa LevSer São Paulo",
    description:
      "Dra. Bruna Durelli, CRM 124809, especialista em obesidade com +10 anos de experiência. Sócia-fundadora da LevSer. Programa personalizado, terapias endoscópicas e medicina regenerativa no Jardim Paulista, São Paulo.",
    keywords:
      "dra bruna durelli, obesidade são paulo, levser, gastroplastia endoscópica, balão gástrico, medicina regenerativa, nutrologia são paulo, jardim paulista, tratamento obesidade",
  ...
  terapiasCirurgicas: {
    title:
      "Cirurgia Bariátrica | Bypass Gástrico e Sleeve - Dra. Bruna Durelli",
    description:
      "Cirurgias bariátricas: Bypass Gástrico e Sleeve Gástrico com técnica videolaparoscópica. Tratamento definitivo para obesidade grave.",
    keywords:
      "cirurgia bariátrica, bypass gástrico, sleeve gástrico, obesidade grave, videolaparoscopia, cirurgia obesidade são paulo",
  ...
  medicinaRegenerativa: {
    ...
    description:
      "Abordagem avançada para saúde metabólica: mais energia, menos inflamação, preservação muscular. Programas individualizados com base em exames.",
    keywords:
      "medicina regenerativa, saúde metabólica, nutrição celular, otimização hormonal, preservação muscular, fadiga crônica, menopausa, pós-bariátrica, performance atlética",
    canonical: "https://drabrunadurelli.com/medicina-regenerativa",
  },
  plasmaArgonio: {
    title: "Plasma de Argônio - Tratamento de Reganho de Peso | LevSer",
    description:
      "Técnica endoscópica minimamente invasiva para tratamento de reganho de peso pós-cirurgia bariátrica e dilatação gástrica. Recuperação rápida e resultados consistentes.",
    keywords:
      "plasma de argônio, reganho de peso, pós-bariátrica, dilatação gástrica, endoscopia, anastomose dilatada, revisão bariátrica, APC",
    canonical: "https://drabrunadurelli.com/plasma-argonio",
  },
  sobre: {
    title: "Sobre a Dra. Bruna Durelli - Especialista em Obesidade | LevSer",
    description:
      "Conheça a trajetória da Dra. Bruna Durelli, especialista em obesidade com +10 anos de experiência. Formação no Einstein, Santa Casa, ABRAN. Sócia-fundadora da LevSer.",
    keywords:
      "dra bruna durelli, especialista obesidade, endoscopia digestiva, nutrologia, medicina regenerativa, levser, são paulo",
  ...
  programaLevser: {
    ...
    description:
      "Programa LevSer: tratamento integrado de obesidade com nutrição, medicina regenerativa, suporte psicológico e procedimentos endoscópicos. Abordagem personalizada e humanizada.",
    keywords:
      "programa levser, tratamento obesidade, emagrecimento saudável, acompanhamento multidisciplinar, são paulo",
  ...
  tratamentos: {
    ...
    description:
      "Conheça todos os tratamentos disponíveis: balão gástrico, gastroplastia, canetas emagrecedoras, medicina regenerativa. Abordagem personalizada para cada caso.",
    keywords:
      "tratamentos obesidade, balão gástrico, gastroplastia, canetas emagrecedoras, medicina regenerativa, são paulo",
  ...
  recursos: {
    ...
    description:
      "Acesse nossos recursos educativos: FAQ completo, calculadoras de IMC e ROI, guias de emagrecimento, vídeos e artigos sobre tratamento de obesidade.",
    keywords:
...
export const generateStructuredData = {
  ...
  localBusiness: {
    ...
    "name": "LevSer - Dra. Bruna Durelli",
    "description":
      "Clínica especializada em tratamento de obesidade. Programa LevSer personalizado, terapias endoscópicas, medicina regenerativa. Jardim Paulista, São Paulo.",
    "url": "https://drabrunadurelli.com",
    "telephone": "+55-11-99702-3024",
    "priceRange": "$$$",
    "address": {
