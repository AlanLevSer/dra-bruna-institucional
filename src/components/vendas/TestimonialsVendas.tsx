  ...
  const testimonials = [
    {
      name: "Maria Silva",
      age: "45 anos",
      text: "Perdi 22kg com o balão e aprendi a comer de verdade. Hoje mantenho o peso sem sofrimento. A equipe esteve comigo em cada etapa.",
      rating: 5,
    },
    {
      name: "Ana Paula",
      age: "38 anos",
      text: "Não foi só o balão, foi uma transformação completa. A diferença está no acompanhamento multidisciplinar — você não está sozinha.",
      rating: 5,
    },
    {
      name: "Juliana Costa",
      age: "52 anos",
      text: "Tentei dieta a vida toda sem sucesso duradouro. Com o programa, finalmente consegui. São 18kg a menos e muita saúde ganha.",
      rating: 5,
    },
  ];
