      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Mais do que um tratamento, um ecossistema completo de transformação sustentável. 
            Sabemos que o investimento em saúde é uma decisão importante. Por isso, criamos opções acessíveis 
            e transparentes, com foco em resultados que duram — não em promessas vazias.
          </p>
        </div>
                ...
                <div className="grid grid-cols-[1fr,auto] gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      type="number"
                      placeholder="0"
                      value={valores.dietas}
                      onChange={(e) => setValores({ ...valores, dietas: e.target.value })}
                ...
                <div className="grid grid-cols-[1fr,auto] gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      type="number"
                      placeholder="0"
                      value={valores.remedios}
                      onChange={(e) => setValores({ ...valores, remedios: e.target.value })}
                      className="w-32 text-right"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr,auto] gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setValores({ ...valores, academia: e.target.value })}
                      className="w-32 text-right"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr,auto] gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      type="number"
                      placeholder="0"
                      value={valores.consultas}
                      onChange={(e) => setValores({ ...valores, consultas: e.target.value })}
                      className="w-32 text-right"
                    />
                  </div>
                </div>
