...
export const CTASection = ({
  ...
  return (
    <section className="relative py-16 bg-gradient-premium overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-primary-foreground mb-5">
          {title}
        </h2>
        ...
        <Button
          ...
          className="bg-card text-foreground hover:bg-card/90 transition-colors group text-sm"
        >
          {buttonText}
