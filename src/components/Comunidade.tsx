  ...
  const beneficios = [
    {
      ...
      description: "Grupo exclusivo com pessoas que entendem seus desafios, sem julgamentos — só acolhimento e troca de experiências verdadeiras.",
    },
    {
      icon: PartyPopper,
      title: "Cada Vitória é Nossa",
      description: "Perdeu 2kg? Conseguiu subir escadas sem cansaço? Aqui, cada conquista sua é motivo de celebração para toda a comunidade.",
    },
    {
      icon: Zap,
      title: "Motivação que Não Para",
      description: "Dias difíceis vão acontecer. Mas aqui você encontra inspiração diária, histórias reais e o lembrete de que você não está só.",
    },
    {
      icon: Heart,
      title: "Amizades que Ficam",
      description: "Mais do que colegas de programa, você vai criar vínculos com pessoas que entendem sua jornada e vibram com seu sucesso.",
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed text-center">
            Aqui, você não é só mais um número. Somos uma força contagiante que inspira e motiva cada pessoa a alcançar suas metas. Compartilhamos estratégias, celebramos vitórias uns dos outros e, principalmente, estamos lado a lado nos momentos difíceis. Cada conquista individual fortalece o grupo inteiro. Esse espírito de apoio mútuo cria um ambiente onde você se sente incentivado(a) a superar desafios, persistir e celebrar cada passo rumo a uma vida mais saudável. <strong className="text-foreground">Estamos juntos nessa jornada — porque, juntos, somos mais fortes e capazes de alcançar grandes feitos.</strong>
          </p>
        </div>
        ...
        <div className="text-center">
          <Button 
            ...
            className="group shadow-elegant hover:shadow-hover transition-all"
          >
