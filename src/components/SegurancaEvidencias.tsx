...
const pilares = [
  {
    ...
    items: [
      "Centro cirúrgico credenciado pela ANVISA",
      "Equipamentos de última geração",
      "Protocolos de biossegurança rigorosos",
      "UTI de retaguarda 24h"
    ]
  },
  {
    icon: Award,
    ...
    items: [
      "Médicos com título de especialista (SBEM, SBCBM)",
      "Nutricionistas, psicólogos e educadores físicos",
      "Anestesistas exclusivos para obesidade",
      "Enfermagem treinada em bariatria"
    ]
  },
  {
    icon: FileCheck,
    ...
    items: [
      "Baseados em guidelines da IFSO",
      "Estudos multicêntricos validados",
      "Atualização contínua com literatura científica",
      "Personalização conforme perfil metabólico"
    ]
  },
  {
    icon: Activity,
    ...
    items: [
      "Telemonitoramento pós-procedimento",
      "Consultas de acompanhamento protocoladas",
      "App com registro de evolução",
...
const resultados = [
  { metrica: "Perda de Peso Total", valor: "15-30%" },
  { metrica: "Perda de Gordura Visceral", valor: "20-40%" },
  { metrica: "Redução de HbA1c", valor: "1-2 pontos" },
  { metrica: "Redução de Colesterol", valor: "20-30%" },
  { metrica: "Redução de Circunferência", valor: "10-20cm" },
  { metrica: "Melhora de Sono/Apneia", valor: "70-85%" },
  { metrica: "Redução de Hipertensão", valor: "50-70%" }
];

const compliance = [
  "Avaliação Pré-Tratamento: Exames laboratoriais completos, avaliação cardiovascular, endoscopia digestiva (quando necessário)",
  "Consentimento Informado: Explicação detalhada de riscos, benefícios e alternativas",
  "Decisão Compartilhada: Você participa ativamente da escolha do melhor protocolo",
  "Riscos Transparentes: Todo procedimento possui riscos, que serão discutidos individualmente"
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Protocolos baseados em pesquisas, adaptados à sua realidade. Sua segurança é nossa prioridade absoluta. 
            Trabalhamos com protocolos internacionais, equipe certificada e infraestrutura de ponta para garantir 
            resultados sem comprometer seu bem-estar.
          </p>
        </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {resultados.map((resultado, index) => (
                  <div key={index} className="flex justify-between items-center p-3 rounded-lg bg-background/50 border border-border/30">
